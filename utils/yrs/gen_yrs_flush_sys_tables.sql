...
** Example Results:
**   \c yellowbrick;
**   \echo Thread 1: ................................Flushing sys  yellowbrick.table: sys._log_query
...
SELECT CASE row_number() OVER (ORDER BY :orderby)  
   WHEN 1 THEN '\c yellowbrick' || CHR(10) 
   ...
   || 'Flushing sys  table: yellowbrick.' || quote_ident(s.nspname) || '.' || quote_ident(t.relname) || CHR(10)
