...
\set num_groups 4
\set orderby 's.nspname, t.relname'

SELECT CASE row_number() OVER (ORDER BY :orderby) WHEN 1 THEN '\c yellowbrick' || CHR(10) || '\i set_gucs.sql' || CHR(10) || '\timing on' || CHR(10) ELSE '' END
