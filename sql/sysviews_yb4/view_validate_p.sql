...
** 
** Note:
** . This procedure is specific to YBD version 4.x. If you are running this 
**   against YB 3.x or 5.x, you need a different version of this procedure. 
**
** Usage:
...
**
** Revision History:
** . 2021.08.30 - Yellowbrick Technical Support 
*/
   ...
   LOOP
      ...
      */
      ...
      LOOP
         ...
         ** but still trip an late bound view created errors.
         */
         _sql_state := '00000';
...
'Description:
Iterates over all views to determine which ones have missing dependencies in
late bound views. 
